<props><bar><group caption="General"><prop caption="icon" editor="textbox" value="[@icon]" description="the url pointing to the icon image."/><prop caption="collapsed" editor="checkbox" value="[@collapsed]" description="collapse panel on load, default is false" values="true|false"/><prop caption="title" editor="textbox" value="[@title]" description="describes content in panel"/></group><group caption="Presentation"><prop caption="skinset" editor="textbox" value="[@skinset]" description="the skinset for
