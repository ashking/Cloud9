<props><notifier><group caption="General"><prop caption="position" editor="dropdown" value="[@position]" description="Vertical and horizontal element's start
