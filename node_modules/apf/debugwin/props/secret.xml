<props><secret><group caption="General"><prop caption="realtime" editor="checkbox" value="[@realtime]" description="whether the value of the bound data is
