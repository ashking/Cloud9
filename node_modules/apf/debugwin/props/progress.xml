<props><progress><group caption="General"><prop caption="autostart" editor="checkbox" value="[@autostart]" description="whether the progressbar starts automatically." values="true|false"/><prop caption="autohide" editor="checkbox" value="[@autohide]" description="whether the progressbar hides when the progress is at 100%. Setting this to true will hide the progressbar at start when autostart is not set to true." values="true|false"/><prop caption="value" editor="textbox" value="[@value]" description="the position of the progressbar stated between
