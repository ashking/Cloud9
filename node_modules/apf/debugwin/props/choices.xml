<props><choices><group caption="General"><prop caption="each" editor="textbox" value="[@each]" description="the xpath statement that determines which
