<props><checkbox><group caption="General"><prop caption="value" editor="textbox" value="[@value]" description="the value of this element."/><prop caption="checked" editor="checkbox" value="[@checked]" description="whether the element is in the checked state." values="true|false"/><prop caption="label" editor="textbox" value="[@label]" description="the caption of the label explaining what
