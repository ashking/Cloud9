<props><browser><group caption="General"><prop caption="src" editor="textbox" value="[@src]" description="the url to be displayed in this element"/><prop caption="value" editor="textbox" value="[@value]" description="alias for the 'url' attribute"/></group><group caption="DataAction"><prop caption="create-model" editor="checkbox" value="[@create-model]" description="whether the model this element connects
