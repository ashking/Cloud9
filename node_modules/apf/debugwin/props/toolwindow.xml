<props><toolwindow><group caption="General"><prop caption="modal" editor="checkbox" value="[@modal]" description="whether the window prevents access to the
