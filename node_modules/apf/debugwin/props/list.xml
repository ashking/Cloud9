<props><list><group caption="General"><prop caption="appearance" editor="dropdown" value="[@appearance]" description="the type of select this element is.
