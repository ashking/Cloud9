<props><text><group caption="General"><prop caption="scrolldown" editor="checkbox" value="[@scrolldown]" description="whether this elements viewport is always
