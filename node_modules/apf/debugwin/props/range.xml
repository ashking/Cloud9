<props><range><group caption="General"><prop caption="realtime" editor="checkbox" value="[@realtime]" description="whether the slider updates it's value realtime,
