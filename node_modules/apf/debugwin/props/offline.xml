...
enableable Cancels the installation of the offline provider"/><prop caption="propertychange" editor="textbox" value="[@propertychange]" type="event" description="Fires when a property changes."/></events></offline></props>