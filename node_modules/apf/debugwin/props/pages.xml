<props><pages><group caption="BaseTab"><prop caption="activepagenr" editor="textbox" value="[@activepagenr]" description="the child number of the active page."/><prop caption="activepage" editor="textbox" value="[@activepage]" description="the name of the active page."/></group><group caption="Presentation"><prop caption="skinset" editor="textbox" value="[@skinset]" description="the skinset for
