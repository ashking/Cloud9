<props><pager><group caption="General"><prop caption="range" editor="textbox" value="[@range]" description="determines how much page buttons is displayed"/><prop caption="previous" editor="textbox" value="[@previous]" description="determines the caption of &quot;go to previous page&quot; button"/><prop caption="next" editor="textbox" value="[@next]" description="determines the caption of &quot;go to next page&quot; button"/></group><group caption="Presentation"><prop caption="skinset" editor="textbox" value="[@skinset]" description="the skinset for
