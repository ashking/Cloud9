<props><radio><group caption="General"><prop caption="submenu" editor="textbox" value="[@submenu]" description="the id of the menu that is shown
...
a reference to an iconmap."/><prop caption="caption" editor="textbox" value="[@caption]" description="the text displayed on the item."/><prop caption="checked" editor="checkbox" value="[@checked]" values="true|false"/><prop caption="selected" editor="checkbox" value="[@selected]" values="true|false"/><prop caption="disabled" editor="checkbox" value="[@disabled]" values="true|false"/></group><group caption="Presentation"><prop caption="skinset" editor="textbox" value="[@skinset]" description="the skinset for
