<props><radiobutton><group caption="General"><prop caption="group" editor="textbox" value="[@group]" description="the name of the group to which this radio
