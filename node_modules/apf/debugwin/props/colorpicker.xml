<props><colorpicker><group caption="General"><prop caption="color" editor="textbox" value="[@color]" description="the color that is selected in the color picker."/><prop caption="value" editor="textbox" value="[@value]" description="the color that is selected in the color picker."/></group><group caption="DataAction"><prop caption="create-model" editor="checkbox" value="[@create-model]" description="whether the model this element connects
