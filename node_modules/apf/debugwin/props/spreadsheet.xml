<props><spreadsheet><group caption="General"><prop caption="iframe" editor="checkbox" value="[@iframe]" values="true|false"/></group><group caption="MultiSelect"><prop caption="multiselect" editor="checkbox" value="[@multiselect]" values="true|false"/><prop caption="autoselect" editor="checkbox" value="[@autoselect]" values="true|false"/><prop caption="selectable" editor="checkbox" value="[@selectable]" values="true|false"/><prop caption="ctrlselect" editor="checkbox" value="[@ctrlselect]" values="true|false"/><prop caption="allowdeselect" editor="checkbox" value="[@allowdeselect]" values="true|false"/><prop caption="reselectable" editor="checkbox" value="[@reselectable]" values="true|false"/><prop caption="default" editor="textbox" value="[@default]" description="the value that this component has when no selection is made."/><prop caption="eachvalue" editor="textbox" value="[@eachvalue]" description="the {@link term.expression expression} that determines the value for each {@link term.datanode data nodes} in the dataset of the element."/><prop caption="value" editor="textbox" value="[@value]" description="the value of the element that is selected."/><prop caption="selection" editor="textbox" value="[@selection]" description="the {@link term.expression expression} that determines the selection for this element. A reference to an xml nodelist can be passed as well."/><prop caption="selected" editor="textbox" value="[@selected]" description="the {@link term.expression expression} that determines the selected node for this element. A reference to an xml element can be passed as well."/></group><group caption="Cache"><prop caption="caching" editor="checkbox" value="[@caching]" values="true|false"/></group><group caption="Rename"><prop caption="rename" editor="checkbox" value="[@rename]" values="true|false"/></group><group caption="BaseTree"><prop caption="openadd" editor="checkbox" value="[@openadd]" values="true|false"/><prop caption="startcollapsed" editor="checkbox" value="[@startcollapsed]" values="true|false"/><prop caption="nocollapse" editor="checkbox" value="[@nocollapse]" values="true|false"/><prop caption="singleopen" editor="checkbox" value="[@singleopen]" values="true|false"/><prop caption="prerender" editor="checkbox" value="[@prerender]" values="true|false"/></group><group caption="DataAction"><prop caption="create-model" editor="checkbox" value="[@create-model]" values="true|false"/></group><group caption="MultiselectBinding"><prop caption="each" editor="textbox" value="[@each]" description="the xpath statement that determines which
...
this node is selectable."/></group><group caption="DataBinding"><prop caption="render-root" editor="checkbox" value="[@render-root]" values="true|false"/><prop caption="empty-message" editor="textbox" value="[@empty-message]" description="the message displayed by this element
...
is accessed."/><prop caption="skin" editor="textbox" value="[@skin]" description="the name of the skin in the skinset that defines
...
aml attributes, loaded data, focus and disabled state."/><prop caption="style" editor="textbox" value="[@style]" description="the css style applied to the this element. This can be a string containing one or more css rules."/><prop caption="class" editor="textbox" value="[@class]" description="the name of the css style class applied to the this element."/></group><group caption="GuiElement"><prop caption="span" editor="textbox" value="[@span]" description="the number of columns this element spans. Only used inside a table element."/><prop caption="left" editor="textbox" value="[@left]" description="the left position of this element. Depending
...
unit can be pixels, a percentage or an expression."/><prop caption="sets" editor="textbox" value="[@sets]" description="this aml element to be editable
that loads new aml as children of this element."/><prop caption="transaction" editor="checkbox" value="[@transaction]" values="true|false"/></group><group caption="Alignment"><prop caption="layout"><prop caption="align" editor="textbox" value="[@align]" description="the edge of the parent to which this
element aligns. Possible values are
a combination of: &quot;left&quot;, &quot;middle&quot;,
&quot;right&quot;, &quot;top&quot;, &quot;bottom&quot; and &quot;slider&quot;
and optionally a size."><prop caption="dock" editor="checkbox" value="[@dock]" default="false" values="true|false"/><prop caption="dockable" editor="checkbox" value="[@dockable]" default="false" values="true|false"/><prop caption="lean" editor="dropdown" value="[@lean]" default="left" description="the position of element when it is ambiguous."><item value="left">left</item><item value="right">right</item><item value="top">top</item><item value="bottom">bottom</item></prop><prop caption="edge" editor="slider" value="[@edge]" default="4" description="the size of the edge of the space between
...
splitter is not displayed."/></prop><prop caption="minwidth" editor="slider" value="[@minwidth]" default="0" description="the minimum horizontal size of this element."/><prop caption="minheight" editor="slider" value="[@minheight]" default="0" description="the minimum vertical size of this element."/></prop></group><group caption="Anchoring"><prop caption="left" editor="textbox" value="[@left]" description="a way to determine the amount of pixels from the left border of this element to the left edge of it's parent's border. This attribute can also contain percentages, arithmetic and even full expressions."/><prop caption="right" editor="textbox" value="[@right]" description="a way to determine the amount of pixels from the right border of this element to the right edge of it's parent's border.This attribute can also contain percentages, arithmetic and even full expressions."/><prop caption="width" editor="textbox" value="[@width]" description="a way to determine the amount of pixels from the left border to the right border of this element.This attribute can also contain percentages, arithmetic and even full expressions."/><prop caption="top" editor="textbox" value="[@top]" description="a way to determine the amount of pixels from the top border of this element to the top edge of it's parent's border.This attribute can also contain percentages, arithmetic and even full expressions."/><prop caption="bottom" editor="textbox" value="[@bottom]" description="a way to determine the amount of pixels from the bottom border of this element to the bottom edge of it's parent's border.This attribute can also contain percentages, arithmetic and even full expressions."/><prop caption="height" editor="textbox" value="[@height]" description="a way to determine the amount of pixels from the top border to the bottom border of this element.This attribute can also contain percentages, arithmetic and even full expressions."/></group><group caption="DelayedRender"><prop caption="render" editor="dropdown" value="[@render]" description="when the contents of this element is rendered."><item value="init">init</item><item value="runtime">runtime</item></prop><prop caption="use-render-delay" editor="checkbox" value="[@use-render-delay]" values="true|false"/></group><group caption="DragDrop"><prop caption="drag" editor="checkbox" value="[@drag]" values="true|false"/><prop caption="dragcopy" editor="checkbox" value="[@dragcopy]" values="true|false"/><prop caption="drop" editor="checkbox" value="[@drop]" values="true|false"/><prop caption="dragdrop" editor="textbox" value="[@dragdrop]" description="the name of the dragdrop element for this element.
&lt;code&gt;
