<props><each><group caption="General"><prop caption="match" editor="textbox" value="[@match]" description="an xpath statement which selects the nodes
