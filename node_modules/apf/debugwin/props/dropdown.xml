<props><dropdown><group caption="General"><prop caption="initial-message" editor="textbox" value="[@initial-message]" description="the message displayed by this element
