...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:a="http://ajax.org/2005/aml" >
    <head>
        ...
        <style>
            ...
            .cdi .first{margin-top : 0;}
            .cdi .last{margin-bottom : 0;}
    ...
    <body>
        ...
        <!-- secure by setting min-width from the top of a sorted list -->
        ...
        <div id="cbox" style="position:absolute;left:0;top:0;right:0;bottom:0;"> <!-- firefox only fix -->
            <div class="cbox" style="width:100%;height:100%;">
            	...
            	<div class="blue filler" style="width:400px">
            		<span>
            		    <div class="button">
        ...
        <div id="cdi" class="cdi" style="position:absolute;left:0;top:0;right:0;bottom:0;width:auto;">
        	<div class="blue button first" style="width:50px;">
        		This is some content.
        	</div><br /><div class="blue button">
        		Only there are four columns! alsj alsd jlasdj alsdja
        	</div><br /><div class="blue big">
        		Four columns!
        	</div><br /><div class="filler blue">
        	    filler
        	</div><br /><div class="blue last" style="width2:100px">
    		    Amazingsdasdasd
    		</div><br />
        </div>
        ...
        <script>
            if (document.all) {
                ...
                cdi.onresize = function(){
                    ...
                    var pH = cdi.offsetWidth - 2 - 4;
                    var fW = 0, vdiff = document.documentMode == 7 ? 40 : 0, hdiff = vdiff;
                    for (var i = 0; i < nodes.length; i++) {
                        var h = hgt[i];
                        if (h < 0) 
                            nodes[i].style.width = Math.max(0, pH - vdiff) + "px";
                        if (!flr[i])
                            fW += nodes[i].offsetWidth + 4;
                    }
                    
                    var rW = cdi.offsetHeight - 2 - 4 - fW - 12;
                    var lW = rW, done = 0;
                    for (var i = 0; i < nodes.length; i++) {
                        if (flr[i]) {
                            var v = Math.round((rW / ttl) * flr[i]);
                            done += flr[i];
                            nodes[i].style.height = ((done == ttl ? lW : v) - 4 - hdiff) + "px";
                            lW -= v;
                        }
                    }
                }
                ...
                setTimeout(function(){
                    cdi.childNodes[2].style.width = "100px";
                }, 1000);
                
                setTimeout(function(){
                    cdi.childNodes[2].style.width = "200px";
                }, 2000);*/
            }
            else
