            ...
            function doCompileJSLT(){
                ...
                try{
                    ...
                    if(lm.indexOf('##')!=-1){
                        ...
                        jsltCode = apf.lm.compile( lm.slice(2), {event:1,parsecode:1,funcglobal:1});
                    }if(lm.indexOf('??')==0){
                        jsltCode = apf.lm.compile( lm.slice(2), {precall:1,parsecode:1});
                    }else{
						//{editable:1,parsecode:0,xpathmode:0} 
                        var opt = {parsecode:0,xpathmode:0,storedyn:1}; 
...
<xml>
 ...
 <folder name='F2'>
  ...
  <file>A</file>
    ...
    <div class="float">
        <h2>Live markup</h2>
        <textarea id='taLM' onkeyup='if(!document.getElementById("nort").checked)doLMProcessing(2)'>(x=y)
		</textarea>
