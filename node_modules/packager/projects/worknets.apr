...
<p:project name="Ajax.org PlatForm" xmlns:p="http://ajax.org/2008/project">
    ...
    <p:process>
        <p:combine
          ...
          defines  = "1"
          group    = "apf"
          out      = "../../www/js/apf_release.js"
          filehead = "1" />

        <!--p:compress
          cmd      = "yuicompressor"
          in       = "../../www/js/apf_release.js"
          out      = "../../www/js/apf_release.js" /-->
    </p:process>
    ...
    <p:files>
        ...
        <p:node path="../../www/js/app.js" group="apf" />
        <p:node path="../../www/js/connections.js" group="apf" />
        <p:node path="../../www/js/create.js" group="apf" />
        <p:node path="../../www/js/editmode.js" group="apf" />
        <p:node path="../../www/js/feed.js" group="apf" />
        <p:node path="../../www/js/geo.js" group="apf" />
        <p:node path="../../www/js/meetup.js" group="apf" />
        <p:node path="../../www/js/messages.js" group="apf" />
        <p:node path="../../www/js/scrollfixed.js" group="apf" />
        <p:node path="../../www/js/questions.js" group="apf" />
        <p:node path="../../www/js/search.js" group="apf" />
        <p:node path="../../www/js/security.js" group="apf" />
        <p:node path="../../www/js/session.js" group="apf" />
        <p:node path="../../www/js/spinner.js" group="apf" />
        <p:node path="../../www/js/loader.js" group="apf" />
        <p:node path="../../www/js/util.js" group="apf" />
        <p:node path="../../www/js/widgetpanel.js" group="apf" />
        <p:node path="../../www/js/feedbackbtn.js" group="apf" />
    </p:files>

    <p:defines defaults="defines_3.0.xml">
